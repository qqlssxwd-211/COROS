...
export default function TabShell({ active, onClose, title, children }: Props) {
  return (
    <div
      ...
      <div className={`absolute bottom-0 left-0 right-0 z-10 w-full max-h-[82vh] overflow-y-auto rounded-t-3xl border-t border-white/6 bg-[rgba(5,5,5,0.97)] px-9 py-7 pb-10 backdrop-blur-2xl transition-transform duration-[450ms] ease-[cubic-bezier(0.22,1,0.36,1)] ${active ? 'translate-y-0' : 'translate-y-full'}`}>
